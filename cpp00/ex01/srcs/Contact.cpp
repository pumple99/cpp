...
/*   Updated: 2023/06/26 19:42:38 by seunghoy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Contact::Preview(void)
{
	...
	std::cout << '|';
	Contact::TruncateAlignPrint(this->_first_name);
	std::cout << '|';
	Contact::TruncateAlignPrint(this->_last_name);
	std::cout << '|';
	Contact::TruncateAlignPrint(this->_nick_name);
	std::cout << std::endl;
}
